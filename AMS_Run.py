...
window = tk.Tk()
window.title("Video Surveillance and Tracking system using Facial Recognition")
...
def manually_fill():
    ...
    def err_screen_for_subject():
        ...
        Button(ec, text='OK', command=ec_delete, fg="black", bg="lawn green", width=9, height=1, activebackground="yellow",
    ...
    def fill_attendance():
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='C:/Users/Admin/Downloads/Attendace_management_system-master (2)/Attendace_management_system-master/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"C:\Users\Admin\Downloads\Attendace_management_system-master (2)\Attendace_management_system-master\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def take_img():
    ...
    if l1 == '':
        ...
        try:
            ...
            detector = cv2.CascadeClassifier('C:\\Users\\Admin\\AppData\\Roaming\\Python\\Python310\\site-packages\\cv2\data\\haarcascade_frontalface_default.xml')
            Enrollment = txt.get()
            Name = txt2.get()
            sampleNum = 0
            while (True):
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                harcascadePath = ("C:\\Users\\Admin\\AppData\\Roaming\\Python\\Python310\\site-packages\\cv2\data\\haarcascade_frontalface_default.xml")
                ...
                root.configure(background='snow')
                cs = 'C:/Users/Admin/Downloads/Attendace_management_system-master (2)/Attendace_management_system-master/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"C:\Users\Admin\Downloads\Attendace_management_system-master (2)\Attendace_management_system-master\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'ds' :
            if password == 'chandni':
                ...
                cs = 'C:/Users/Admin/Downloads/Attendace_management_system-master (2)/Attendace_management_system-master/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="Video Surveillance and Tracking system using Facial Recognition", bg="white", fg="black", width=50,
